...
export default function SurveySection() {
  ...
  return (
    <section className="py-16 my-16 rounded-2xl bg-gradient-to-br from-[#8B0000] via-[#6b0000] to-[#4a0000] relative overflow-hidden">
      {/* Decorative elements */}
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/3">
            {years.length === 0 ? (
              ...
              <Accordion type="single" collapsible defaultValue={categoryOrder[0]} className="w-full space-y-0">
                {categoryOrder.map((category) => (
                  <AccordionItem
                    key={category}
                    value={category}
                    className="bg-white/95 backdrop-blur-sm rounded-xl mb-4 border border-white/20 overflow-hidden hover:shadow-lg transition-shadow duration-300"
                  >
                    <AccordionTrigger className="bg-gradient-to-r from-[#8B0000] to-[#6b0000] text-white font-bold hover:no-underline hover:shadow-md px-6 py-4">
                      {categoryLabels[category]} {selectedYear}
                    </AccordionTrigger>
                    <AccordionContent className="bg-white px-0 pt-0 pb-0">
